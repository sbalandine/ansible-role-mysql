...
(RedHat/CentOS only) If you have enabled any additional repositories (might I suggest sbalandine.repo-epel or sbalandine.repo-remi), those repositories can be listed under this variable (e.g. `remi,epel`). This can be handy, as an example, if you want to install later versions of MySQL.
